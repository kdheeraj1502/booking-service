...
public class CabBookingsServiceImpl implements CabBookingsService {
	
	@Autowired
	CabBookingsService service;
	...
	@Override
	public Driver save(Driver details) {
	...
	@Override
	public int setLocation(Double firstname, Double lastname, int id) {
		return service.setLocation(firstname, lastname, id);
	}
